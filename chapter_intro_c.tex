...
\begin{figure} %[H]
        \centering
                \includegraphics[width=.5\textwidth]{figures/sensitivity_v3_noOverlain.png}
                \caption{Majorana neutrino mass vs. the minimum of the three neutrino masses, for both the normal and inverted hierarchies.  The dotted (solid) lines denote the 1(2)-$\sigma$ region allowed by neutrino oscillation measurements.}
...
\begin{figure} %[H]
	...
	\caption{Projected nEXO sensitivity to the effective Majorana neutrino mass, overlain on $\braket{m_{\nu}}$ vs. the minimum of the three neutrino masses for both NH and IH.  The dotted (solid) lines denote the 1(2)-$\sigma$ region allowed by neutrino oscillation measurements.}
