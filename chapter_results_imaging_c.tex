...
\begin{figure} %[H]
        \centering
                ...
                \caption{Raw images through 620-nm band-pass filter of a Ba\textsuperscript{+} deposit yielding $\leq 470$ average number of Ba atoms, with its preceding and succeeding Xe-only deposits.  Exposures are 10~s with 0.6~mW of 566~nm excitation focused with bi-convex lens to w = 5~$\mu$m.}
