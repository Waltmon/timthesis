...
%, as discussed in \ref{sec:bleaching}
...
%                \includegraphics[width=.5\textwidth]{figures/lin_just20150526_lin_uncut.png}
                \includegraphics[width=.5\textwidth]{figures/lin_just20150526_circles.png}
                \caption{Total 619-nm signal, scaled by laser power, vs. instantaneous number of Ba\textsuperscript{+} ions deposited in the focal region of a laser at 570~nm for experiments with (a) aspherical, and (b) bi-convex laser focusing lenses.  The exposure times are (a) 60~s, and (b) 3~s.  In (b), the open circles correspond to runs where the surface background was less certain.}
\label{fig:lin}
\end{figure}
