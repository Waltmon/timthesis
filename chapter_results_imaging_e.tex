...
%                \includegraphics[width=.45\textwidth]{figures/scans_dframeXe.png}
                \caption{\emph{\color{gray}needs (a),...}Early attempts at scanned images of a few deposits: (a) 0.48 average Ba\textsuperscript{+}/step, (b) Xe-only, (c) 0.63 average Ba\textsuperscript{+}/step, and (d) 5.7 average Ba\textsuperscript{+}/step.  Exposures are 10-s with 0.4-0.5~mW of focused 570~nm laser.}
\label{fig:scans}
\end{figure}
%, and (d) Xe-only
