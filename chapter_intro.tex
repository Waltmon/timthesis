...
\begin{table}[!htbp]
\caption{Best-fit values for neutrino oscillation parameters, from a global fit to oscillation experiment data.   {\color{red}[talk about definition of atsmopheric thing relying on hierarchy]}\cite{ReviewNuMass}} %not sure what [Small Table], between \caption and {}, w/ no spaces, does
...
\begin{figure}[H]
	...
	\caption{nEXO projected sensitivity to the Majorana neutrino mass vs. the sum of the three masses M$_{total}$. {\color{red}Is there an updated version?}  {\color{blue}``To make this plot we used the best fit values of the mixing
