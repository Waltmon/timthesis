...
The measurement blah blah blah ... two $\nu$ is rare but 0 $\nu$ is even more rare since we've never seen it, blah blah blah EXO

or: The rarity of double beta decay (see the very long half lives in Table (table)) requires very low backgrounds

{\color{gray}[experiments -- refer to next section for EXO]}
