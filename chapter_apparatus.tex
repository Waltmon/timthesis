...
An aspherical lens focuses the laser into the cryostat from the side (Fig. \ref{fig:endOfBeam}).  To calculate the laser spot size in the SXe, ... \emph{\color{red}is the w$_{0}$ in air needed (then show [waist measurements -- apply calibration uncertainty to the good motor-stage ones]), or just the f of the lens?  Talk about the ray matrix calc, and of astigmatism, and show measurements of astig. w/ and w/o compensator.}
