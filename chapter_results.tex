...
\begin{figure} %[H]
        \centering
                \includegraphics[width=.7\textwidth]{figures/cryovibes_a.png}
                \caption{make into smal plot for side by side}
