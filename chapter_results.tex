...
\emph{\color{red}Describe how you align here, cuz this is the first mentioned where the w is important and is defocused -- observe focused image, find its focus, and defocus by an amount, then centering the broad Ba fluorescence for a known intensity region of x\%:}  \textbf{To produce a well-known laser intensity, care was taken in de-focusing the laser and centering its image in the CCD region of interest (ROI).  ... describe}
