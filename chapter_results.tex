...
Decay of fluorescence with laser exposure, or bleaching, 

\emph{\color{gray}\textbf{um, or not, ala other statements:} Describe how you align here -- observe focused image, find its focus, and defocus by an amount, then centering the broad Ba fluorescence for a known intensity region of x\% ... \textbf{do you want an explanation of the image in experimental?  or maybe this is a good place to introduce it?}}
...
\emph{\color{red}Begin here for proof reading.}
