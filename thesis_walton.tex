...
%old dedication was here, and yes it had the \newline:
\newpage
\input{dedication}
...
\input{chapter_intro_c}
\input{chapter_theory_b}
\input{chapter_apparatus_b}
\input{chapter_procedure_b}
\input{chapter_results_spectroscopy_c}
\input{chapter_results_imaging_e}
\input{chapter_conclusions_b}
...
\newpage
 ...
 \bibitem{Kendy} K. Hall, \emph{In-situ Laser Tagging of Barium Ions in Liquid Xenon for the EXO Experiment.}  Colorado State University Thesis/Dissertation (2012).
...
%ALPHAION WAS HERE
 ...
 \bibitem{ColutronCompany} Now Beam Imaging Solutions, 1610 Pace St., Unit 900, \#303, Longmont, CO 80504.
 ...
 \bibitem{PrincetonInstruments} Measured by Princeton Instruments (New Jersey) prior to shipment (2004).
...
%-------------------------------%
 ...
 \bibitem{singleMoleculePulsed} W. Patrick Ambrose \emph{et al.}, \emph{Chem. Rev.} \textbf{99}, 2929-2956 (1999).
 ...
 %\appendix
 %\input{appendix_fitting}
 %\input{appendix_backgrounds}
