...
%Finally, a system for scanning the focused laser across the sapphire window is discussed in Sec. \ref{sec:laserscanning}.
...
%This indicates the level of drift in optimal ion beam component settings that occur over a long period of time.
...
\begin{figure} %[H]
        \centering
                \includegraphics[width=.33\textwidth]{figures/astig_thesis_2Dgaus_red_run35.png}
                ~
                \includegraphics[width=.33\textwidth]{figures/astig_thesis_2Dgaus_red_run39.png}
                ~
                \includegraphics[width=.33\textwidth]{figures/astig_thesis_2Dgaus_red_run43.png}
...
When a 1" diameter filter is used, the imaging system has a solid angle of light collection of 1.5\%.  Each additional component in the collection optics, listed in Table \ref{table:colleff}, contributes some loss, resulting in a total collection efficiency ($\epsilon_{c}$) of $2.2 \times 10^{-3}$ with the spectrometer, and $4.5 \times 10^{-3}$ without.  The spectrometer f-number of 4 is not limiting in this setup.
