...
//	Double_t m32 = (2.43 + del_m32)*1.E-3));
	...
	f[fn]=new TF1(Form("f%d",fn),Form("%f*%f*%f*x + %f*%f*%f*sqrt(x**2-%f) + %f*%f*sqrt(%f+x**2+%f/2.)",c12_sq,c13_sq,Re_eialpha1,s12_sq,c13_sq,Re_eialpha2,Delta_m12_sq,s13_sq,Re_neg2idelta,Delta_m_sq,Delta_m12_sq),1.e-4,1.);
