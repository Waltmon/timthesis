...
//	Double_t m32 = (2.43 + del_m32)*1.E-3));
	...
	f[fn]=new TF1(Form("f%d",fn),Form("sqrt(    (%f*%f*x + %f*%f*%f*sqrt(x**2-%f) + %f*%f*sqrt(%f+x**2+%f/2.))**2     +     (%f*%f*%f*sqrt(x**2-%f) + %f*%f*sqrt(%f+x**2+%f/2.))**2    )",c12_sq,c13_sq,    s12_sq,c13_sq,cos(alpha1),Delta_m12_sq,   s13_sq,cos(alpha2-2*delta),Delta_m_sq,Delta_m12_sq,      s12_sq,c13_sq,sin(alpha1),Delta_m12_sq,     s13_sq,sin(alpha2-2*delta),Delta_m_sq,Delta_m12_sq),1.e-4,1.);
...
void nh_wrong_I_think(Double_t del_m12=0., Double_t del_m=0., Double_t del_t12=0., Double_t del_t23=0., Double_t del_t13=0., Double_t delta=0., Double_t alpha1=0., Double_t alpha2=0.) {
//ignore powers of 10
...
void ih_wrong_I_think_andJustRe(Double_t del_m12=0., Double_t del_m=0., Double_t del_t12=0., Double_t del_t23=0., Double_t del_t13=0., Double_t delta=0., Double_t alpha1=0., Double_t alpha2=0.) {
//ignore powers of 10
