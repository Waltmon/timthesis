...
\begin{figure} %[h]
        \centering
                ...
                \caption{Integrated 619-nm fluorescence counts/mW for three laser powers, with exposure time scaled to conserve $I \times t$.  Excitation is 570~nm focused to $w_{x} \times w_{y}$ beam waists of 2.06~$\mu$m $\times$ 2.66~$\mu$m. All one deposit of 5~s continuous Ba\textsuperscript{+} at 50~K, observed at 11~K from low to high laser intensity.}
