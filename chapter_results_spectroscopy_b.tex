...
\begin{figure} %[H]
        \centering
                \includegraphics[width=.8\textwidth]{figures/excitspec_grn_spectra_v2.png}
                \includegraphics[width=.9\textwidth]{figures/excitspec_grn.png}
                \caption{(a) Background-subtracted fluorescence spectra for a few different excitation wavelengths, and (b) excitation spectra for all observed Ba fluorescence peaks.  Magnitudes in (b) have been scaled for visibility on the same plot.  Exposures are 1~s. \emph{\color{gray}fix text sizes}}
