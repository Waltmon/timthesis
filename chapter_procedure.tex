...
The choice of 570~nm for excitation of the 619-nm fluorescence peak was made by an optimization of $S$/$\sqrt{B}$, where $S$ is the 619-nm signal and the background $B$ is a combination of the surface emission and the sapphire bulk emission.  This was determined by plotting the ratio between binned versions of the respective excitation spectra, shown in Fig. \ref{fig:StoB}.
