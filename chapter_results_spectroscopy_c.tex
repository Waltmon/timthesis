...
%Backgrounds are analyzed in Sec. \ref{sec:bgs} in order to optimize sensitivity,
...
\begin{figure} %[H]
        \centering
                ...
                \caption{Bleaching of Ba spectra with excitation at (a) 556.9~nm, (b) 562.6~nm, and (c) 566.3~nm.  Laser power and exposure times are (a) 1.3~mW and 1~s, (b) 7.5~mW and 0.2~s, and (c) 5.8~mW and 0.2~s.  Every tenth exposure is shown, beginning with the 2\textsuperscript{nd} in the darkest blue, ending with the darkest red.  Each is a 5-s continuous Ba\textsuperscript{+} deposit at 45~K, observed at 11~K. \cite{Mong2015}}
...
\end{figure}
%RUNS(after redundant remove):  (a) is either 180 or 181, (b) is 137 and 139, (c) is 161 and 163 (2014-06-26)
...
\begin{figure} %[H]
        \centering
                ...
                \includegraphics[width=.7\textwidth]{figures/excitspec_blu_b.png}
...
%\subsection{Emission of Sr in SXe}

%Two emission peaks at 484~nm and 492~nm, shown in Fig. []a, have been observed in Ba getter deposits in SXe at 11~K \cite{Brian,Mong2015} with blue excitation.  Excitation spectra for these peaks, as well as for the Ba emission peak at 596~nm, are shown in Fig. []b.  It is suggested in \cite{Mong2015} that the 484- and 492-nm emission peaks could be due to transitions between $6s5d$ and $6s7p$ states for Ba in SXe.  However, ...
