...
The fluorescence efficiency $\epsilon_{f}$ is the total number of photons emitted per photons absorbed (Sec. \ref{sec:fluorEff}).  This was measured in the first of exposure, before substantial bleaching has occurred, and is plotted vs. $W_{12}$ in Fig. \ref{fig:qe} for the 577- and 591-nm peaks.  Fluorescence efficiency is fairly constant below $W_{12} \approx 100$~s\textsuperscript{-1}, and begins to decline at higher $W_{12}$.  This is explained by the effect of greater bleaching at higher $W_{12}$ in the first exposure.  Using the lowest values of $W_{12}$, $\epsilon_{f}$ is measured to be about $2 \times 10^{-3}$ for the 591-nm peak with 562.6-nm excitation, and $5 \times 10^{-4}$ for the 577-nm peak with 566.3-nm excitation.  The bleaching model does not explain such small fluorescence efficiency.  However, these values assume that 100\% of deposited Ba\textsuperscript{+} ions are observable by these fluorescence peaks, which may not be the case.
...
Several additional emission peaks are prominent in deposits made at 50$\pm$5~K and observed at 11~K.  Representative spectra at four blue excitation wavelengths are shown in \ref{fig:excitspecBlue}(a).  Peaks at 532, 553, 568, 592, 635, and 669~nm are observed.  Excitation spectra for these peaks are shown in \ref{fig:excitspecBlue}(b).  The largest peaks at 532~nm and 635~nm have identical excitation spectra, indicating that they are due to the same excitation transition.  It is possible that the 532- and 635-nm peaks are emission from the P $\rightarrow$ S and P $\rightarrow$ D transitions, respectively, of matrix-isolated Ba\textsuperscript{+} ions.  However, matrix effects would need to be responsible for the higher number of counts observed in the 635nm peak vs. the 532-nm peak, whereas the P $\rightarrow$ S transition is about 4$\times$ more likely than the P $\rightarrow$ D transition in vacuum.  Further study of these emission peaks is needed to assign them to Ba\textsuperscript{+}.
